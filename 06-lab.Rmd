...
```{r}
num_missing_abstracts <- sum(is.na(abstracts) | abstracts == "")
...
_15 of them don't have an abstract_
...
```{r}
num_missing_titles <- sum(is.na(titles) | titles == "")
